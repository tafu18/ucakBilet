...
<?php
    ...
    echo "<th>Uçuş No</th><th>Kalkış Zamanı</th><th>Varış Zamanı</th><th>Şehir</th><th>Kullanıcı Adı</th><th>Koltuklar</th><th>Kalkış Tarihi</th><th>Kalkış Şehir</th><th>Varış Şehir</th><th>Kategori</th><th>Durum</th><th>Ücret</th>";
    while($dizi=mysqli_fetch_array($sec))
    {
        ...
        echo ("<td>$dizi[4]</td> <td>$dizi[5]</td><td>$dizi[6]</td><td>$dizi[7]</td><td>$dizi[8]</td><td>$dizi[9]</td><td>$dizi[10]</td><td>$dizi[11]</td></tr>");
    }
    echo "</table>";
